...
!
!===============================================================================
subroutine write_newyear_mesh_diag
  ...
  ! Reviewed by ??
  !
  ! modified to do output every year: Ralph Timmermann 14.07.2015 RG45190
  !--------------------------------------------------------------------------  
...
#include "netcdf.inc" 
  ...
  character(4)              :: cnewyear

  write(cnewyear,'(i4)') yearnew

  if (mype==0) then  ! create a file

     filename=trim(ResultPath)//runid//'.'//cnewyear//'.mesh.diag.nc'
...
end subroutine write_newyear_mesh_diag
!
!===============================================================================
